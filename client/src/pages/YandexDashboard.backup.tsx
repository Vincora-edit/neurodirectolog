...
const CircularProgress = ({
  ...
  const svgSize = size + 20; // Extra space for outer ring
  const offset2 = 10; // Offset to center

  return (
    <div className="flex flex-col items-center">
      <div className="relative" style={{ width: size, height: size }}>
        {/* Background circle */}
        <svg className="transform -rotate-90" width={svgSize} height={svgSize} style={{ marginLeft: -offset2, marginTop: -offset2 }}>
          <circle
            cx={svgSize / 2}
            cy={svgSize / 2}
            r={radius}
          ...
          {dayValue !== undefined && (
            <circle
              ...
              strokeDashoffset={outerRadius * 2 * Math.PI - (dayProgress / 100) * outerRadius * 2 * Math.PI}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="mt-3 text-center">
                  ...
                  <div className="text-xs text-gray-500">
                    {Math.round(kpiData?.stats?.currentCpl || 0).toLocaleString('ru-RU')} / {((kpiData?.kpi?.targetCpl || 0)).toLocaleString('ru-RU')} ₽
                  </div>
                </div>
              </div>
