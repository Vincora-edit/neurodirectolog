...
ВАЖНО: Учитывай ВСЕ формы слова! Если "гражданство" целевое, то и "гражданину", "гражданина", "гражданам" тоже целевые.
Примеры целевых запросов: "как получить гражданство гражданину армении", "внж для гражданина украины"

Проанализируй описание бизнеса и определи ключевые понятия ниши. Все слова связанные с этими понятиями - ЦЕЛЕВЫЕ.

=== МОЖНО МИНУСОВАТЬ (только с 100% уверенностью) ===
1. ЯВНО ДРУГАЯ НИША: слова которые 100% не относятся к бизнесу (например "автомобиль" для миграционных услуг)
2. ИНОСТРАННЫЕ: английские слова для русскоязычного бизнеса
3. ИНФОРМАЦИОННЫЕ БЕЗ КОММЕРЦИИ (только с !): !осталось, !изменения, !статистика, !новости
4. ОПЕЧАТКИ: явные ошибки написания

=== КАТЕГОРИЧЕСКИ ЗАПРЕЩЕНО МИНУСОВАТЬ ===
- Формы ключевых слов бизнеса (гражданину, гражданина = форма от "гражданство")
- Коммерческие слова: цены, стоимость, консультация, помощь, услуги, документы, сколько
- Слова связанные с нишей бизнеса в ЛЮБОЙ форме
- Организации/учреждения - клиенты ищут услуги РЯДОМ с госорганами
- География (города/районы)
- Спорные слова

=== ОПЕРАТОРЫ (КРИТИЧНО!) ===
- ! (фиксация формы) - ОБЯЗАТЕЛЬНО для информационных слов
  Пример: !осталось - заблокирует только "осталось", не "остаться"
- "" - только для аббревиатур
...
🚫 КРИТИЧЕСКИЕ ПРАВИЛА:
1. Формы слов из ниши (гражданину от гражданство) = ЦЕЛЕВЫЕ, НЕ ВКЛЮЧАТЬ
2. Если слово МОЖЕТ появиться в целевом запросе → НЕ ВКЛЮЧАТЬ
3. Слова с 2+ формами в бизнесе → НЕ ВКЛЮЧАТЬ
4. Информационные слова → ТОЛЬКО с оператором !
5. Лучше вернуть ПУСТОЙ массив чем ошибиться
6. Максимум 2-3 слова - только 100% мусор из другой ниши!`;
