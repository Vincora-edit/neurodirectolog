...
Проанализируй описание бизнеса выше и определи:
1. Какие слова связаны с нишей бизнеса (НЕ минусовать)
2. Какие слова коммерческие: цены, стоимость, заказать, купить, услуги (НЕ минусовать)
3. Какие слова могут привести клиента даже косвенно (НЕ минусовать)

=== МОЖНО МИНУСОВАТЬ (только с 100% уверенностью) ===
1. ЯВНО ДРУГАЯ НИША: слова которые 100% не относятся к бизнесу
2. ИНОСТРАННЫЕ: английские слова для русскоязычного бизнеса
3. ИНФОРМАЦИОННЫЕ (только с !): !осталось, !изменения, !новости, !статистика
4. ОПЕЧАТКИ: явные ошибки написания

=== ОПЕРАТОРЫ (КРИТИЧНО!) ===
- ! (фиксация формы) - ОБЯЗАТЕЛЬНО для информационных слов и спорных форм
  Пример: !помощи - не заденет "помощь", !европейскому - не заденет "европейский"
- "" - только для аббревиатур
- Без оператора - ТОЛЬКО для 100% мусора (другая ниша, английские слова)

=== НЕ МИНУСОВАТЬ ===
- Слова связанные с нишей бизнеса (анализируй описание!)
- Коммерческие слова: цены, стоимость, консультация, помощь, услуги, документы
- Организации/учреждения/службы - клиенты ищут услуги РЯДОМ с госорганами
- География (города/районы) - требует отдельного анализа
- Спорные слова - лучше пропустить
...
🚫 КРИТИЧЕСКИЕ ПРАВИЛА:
1. АНАЛИЗИРУЙ описание бизнеса - слова связанные с нишей НЕ ВКЛЮЧАТЬ
2. Если слово МОЖЕТ появиться в целевом запросе → НЕ ВКЛЮЧАТЬ
3. Спорные слова → НЕ ВКЛЮЧАТЬ (лучше пропустить)
4. Информационные слова → ТОЛЬКО с оператором !
5. Разные формы слова: !помощи не заденет "помощь"
6. Лучше вернуть ПУСТОЙ массив чем ошибиться
7. Максимум 3-5 слов - только 100% мусор!`;
